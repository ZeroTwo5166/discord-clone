...
export default function Home() {
    ...
    useEffect(() => {
        ...
        setInit(true);
        setLoading(false); // Mark loading as complete when particles are initialized
        });
    }, []);
            ...
            <>
                ...
                <div className="z-10 relative flex flex-col items-center justify-center h-screen">
                    <div className="absolute top-0 left-0 right-0 p-4 text-center">
                        <h1 className="text-3xl font-bold mb-2 text-blue-800">Discord Clone</h1>
                        <span className="text-sm text-gray-500">Alpha version</span>
                    </div>
                    <div className="flex mt-32 ml-10"> {/* Increase mt-20 to move buttons down */}
                        <button 
...
/*
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-white">
                <h1 className="text-6xl font-bold mb-4">Test Version</h1>
